...
echo 'Wiring OverviewDashboard to real Supabase data...'
...
git add -A
git commit -m 'Wire OverviewDashboard to real Supabase data: bookings, earnings, online toggle, realtime'
